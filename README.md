...
## Description
Unofficial audio driver package.

### Supported Hardware
- Realtek Audio chips (ALC210 - ALC1220)
- ASUS Strix SOAR/RAID PRO/DLX

### System Requirements
- Windows 10/11 x64 (Build 19044 or later)
...
5. Select **ASUS Strix Sound Card**.
6. Select **Smart Clean** or **Force Clean** to remove old driver leftovers.
7. Select **Install Driver Set** and choose configuration.
8. Restart PC.
